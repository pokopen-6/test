	...
	<div id="main">
		...
		<table>
			...
			<tr>
				...
				<th><div id="x">
				<label>
					<s:checkbox name="selectItemList" value="0" fieldValue="%{id}" theme="simple"  />製品名：<s:property value="product_name"/>
				</label><br>
				</div>
				</th>
				<td><div id="x"><s:property value="product_description"/><br></div>
				<div id="x">個数：<select name="stock">
				...
				<div id="x">製品価格（税込）￥ <s:property value="product_price" /> /個<br></div></td>
			</tr>
			</s:iterator>
